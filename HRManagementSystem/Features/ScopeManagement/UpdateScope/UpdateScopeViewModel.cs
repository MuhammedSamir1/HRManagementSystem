...
{
    public sealed record UpdateScopeViewModel(
        Guid Id,
        Guid OrganizationId,
        Guid CompanyId,
        Guid BranchId,
    ...
    public sealed class UpdateScopeViewModelValidator : AbstractValidator<UpdateScopeViewModel>
    {
        public UpdateScopeViewModelValidator()
        {
            RuleFor(x => x.Id)
