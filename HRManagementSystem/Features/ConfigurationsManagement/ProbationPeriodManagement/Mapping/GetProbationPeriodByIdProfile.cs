...
using HRManagementSystem.Features.ConfigurationsManagement.ProbationPeriodManagement.GetProbationPeriodById;

namespace HRManagementSystem.Features.ConfigurationsManagement.ProbationPeriodManagement.Mapping
{
    public sealed class GetProbationPeriodByIdProfile : Profile
    {
        public GetProbationPeriodByIdProfile()
        {
            CreateMap<ProbationPeriod, ViewProbationPeriodByIdDto>()
          .ForMember(d => d.Id,
              o => o.MapFrom(s => s.Id))
          ...
          .ForMember(d => d.Status,
            ...
            CreateMap<ViewProbationPeriodByIdDto, ViewProbationPeriodByIdViewModel>().ReverseMap();
        }
    }
}
