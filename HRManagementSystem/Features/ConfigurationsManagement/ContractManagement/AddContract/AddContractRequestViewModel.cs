...
namespace HRManagementSystem.Features.ConfigurationsManagement.ContractManagement.AddContract
{
    public record AddContractRequestViewModel(
    ...
    {
        public AddContractRequestViewModelValidator()
        {
