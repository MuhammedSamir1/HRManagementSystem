...
using HRManagementSystem.Features.HolidayManagement.GetHolidayById.Queries;
...
namespace HRManagementSystem.Features.HolidayManagement.GetHolidayById
{
    public class GetHolidayByIdEndPoint : BaseEndPoint<object, ResponseViewModel<object>>
    {
        ...
        [HttpGet("{id:int}")]
        public async Task<ResponseViewModel<ViewHolidayViewModel>> GetHolidayById([FromRoute] int id, CancellationToken ct) 
        {
            // 1.  Query  DTO
