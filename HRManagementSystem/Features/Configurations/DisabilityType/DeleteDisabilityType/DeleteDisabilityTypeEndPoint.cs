using HRManagementSystem.Features.Configurations.DisabilityType.DeleteDisabilityType.Command;

namespace HRManagementSystem.Features.Configurations.DisabilityType.DeleteDisabilityType
{
