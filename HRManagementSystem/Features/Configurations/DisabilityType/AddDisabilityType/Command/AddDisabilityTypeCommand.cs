...
using HRManagementSystem.Features.Configurations.DisabilityType.AddDisabilityType.Queries;

namespace HRManagementSystem.Features.Configurations.DisabilityType.AddDisabilityType.Command
{
