using HRManagementSystem.Features.ProbationPeriodManagement.GetProbationPeriodById.Queries;

namespace HRManagementSystem.Features.ProbationPeriodManagement.GetProbationPeriodById
{
