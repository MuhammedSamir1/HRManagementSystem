...
namespace HRManagementSystem.Features.ProbationPeriodManagement.UpdateProbationPeriod
{
    ...
    public sealed class UpdateProbationPeriodViewModelValidator : AbstractValidator<UpdateProbationPeriodViewModel>
    {
        public UpdateProbationPeriodViewModelValidator()
        {
            RuleFor(x => x.Id)
