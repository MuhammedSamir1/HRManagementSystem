...
using HRManagementSystem.Features.PayrollManagement.OvertimeRateManagement.UpdateOvertimeRate.ViewModels;
...
namespace HRManagementSystem.Features.PayrollManagement.PayrollItemManagement.Mapping
{
    public class PayrollMappingProfile: Profile
    {
        public PayrollMappingProfile()
        {
            ...
            CreateMap<PayrollItem, PayrollItemDto>(); // للتحويل بعد الحفظ
