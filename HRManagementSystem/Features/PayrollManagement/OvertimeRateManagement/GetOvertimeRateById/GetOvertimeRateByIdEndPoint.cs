...
namespace HRManagementSystem.Features.PayrollManagement.OvertimeRateManagement.GetOvertimeRateById
{
        ...
        : BaseEndPoint<int, ResponseViewModel<OvertimeRateDto>>
    {
        ...
        [HttpGet("payroll/overtime-rates/{id:int}")] // مثال: GET /api/payroll/overtime-rates/5
